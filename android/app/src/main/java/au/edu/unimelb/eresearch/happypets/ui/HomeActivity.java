...
import au.edu.unimelb.eresearch.happypets.ui.fragments.AboutFragment;
import au.edu.unimelb.eresearch.happypets.ui.fragments.BreedListFragment;
import au.edu.unimelb.eresearch.happypets.ui.fragments.HomeFragment;
...
public class HomeActivity extends BaseActivity {
    ...
    private static final String FRAG_BREEDS = "Fragment Breeds";
        ...
        if (newFragment != null) {
            ...
            switch (newFragId) {
                case FRAG_HOME:
                    ...
                    break;
                case FRAG_BREEDS:
                    newFragment = new BreedListFragment();
                    break;
                case FRAG_ABOUT:
